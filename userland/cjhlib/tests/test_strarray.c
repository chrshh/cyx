...
int main() {
  ...
  // --- Split: basic ---
  printf("--- Split ---\n");
  String csv = StringFromLiteral("one,two,three");
  ...
  String noDelim = StringFromLiteral("hello");
  ...
  String pair = StringFromLiteral("hello world");
  ...
  String path = StringFromLiteral("a/b/c/d/e");
